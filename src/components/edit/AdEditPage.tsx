...
const getOptionalInputStyles = (value?: string): { input: CSSProperties, label: CSSProperties } => ({
    label: {
        fontSize: 14,
        fontWeight: 400,
        color: 'rgba(0, 0, 0, 0.85)',
...
const AdEditPage = () => {
    ...
    const draft = useAdEditStore((state) => state.drafts[itemKey]);
    const setDraft = useAdEditStore((state) => state.setDraft);
    const clearDraft = useAdEditStore((state) => state.clearDraft);
    ...
    useEffect(() => {
        ...
        const nextForm = draft ?? getInitialState(item);
        setForm(nextForm);

        if (!draft) {
            setDraft(itemKey, nextForm);
        }

        initializedItemIdRef.current = itemId;
    }, [item, itemId, itemKey, draft, setDraft]);
    ...
    return (
        <Box bg="#f7f5f8" mih="100vh" p={24}>
            ...
            <Paper radius={24} p={32} bg="#fff">
                <Title order={2} c={'rgba(0, 0, 0, 0.85)'} ff={'var(--font-family)'} fw={500} fz={30} mb={24}>
                    Редактирование объявления
                </Title>

                <Flex direction="column" gap={16}>
                    <Select
                        ff={'var(--second-family)'} fw={600}
                        fz={16}
                        c={'rgba(0, 0, 0, 0.85)'}
                        label="Категория"
                    ...
                    <Box>
                        <Text ff={'var(--second-family)'} fw={600} fz={16} lh="140%" c="rgba(0, 0, 0, 0.85)">
                            <Text span c="#ff4d4f">
                                *
                            </Text> Название
                        </Text>
                    ...
                    <Flex align="flex-end" gap={20} wrap="wrap">
                        <Box>
                            <Text mb={8} ff={'var(--second-family)'} fw={600} fz={16} lh="140%" c="rgba(0, 0, 0, 0.85)">
                                <Text span c="#ff4d4f">
                                    *
                                </Text> Цена
                            </Text>
                    ...
                    <Title order={3} c={'rgba(0, 0, 0, 0.85)'} ff={'var(--second-family)'} fw={600} fz={16}>
                        Характеристики
                    </Title>
                        ...
                        {form.category === "Авто" && (
                            <>
                                ...
                                <TextInput
                                    ...
                                    onChange={(e) => updateParam("yearOfManufacture", e.currentTarget.value)}
                    ...
                    <Box>
                        <Text ff={'var(--second-family)'} fw={600} fz={16} mb={8} c={'color: rgba(0, 0, 0, 0.85)'}>
                            Описание
                        </Text>
                                    ...
                                    {descriptionAi.error ? (
                                        ...
                                        <Box>
                                            ...
                                            <Flex justify="space-between" mt={16}>
                                                ...
                                                <Button onClick={handleApplyDescription}>Применить</Button>
                                            </Flex>
                                        </Box>
